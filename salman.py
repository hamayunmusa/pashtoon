...
# source code by Salman farooq
# salman decompile done 3:)
...
def reg2():
    ...
    print ''
    print '\x1b[1;96m '
    print ' \xe2\x80\xa2 THIS TOOL IS COMPLETELY CODED BY SALMAN FAROOQ \xe2\x80\xa2 '
    time.sleep(5)
    login()
...
def menu():
    ...
    print ''
    print 47 * '-'
    print ' \x1b[1;91m          DONT COPY MY STYLE'
    print '         NEVER JUDGE A BOOK BY ITS COVER'
    print '\x1b[1;97m'
    print 47 * '-'
    print ''
    print ' [1] START'
    print ' [2] FOLLOW ME ON FB '
